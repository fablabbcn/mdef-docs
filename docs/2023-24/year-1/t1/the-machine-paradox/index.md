<div class="banner-modules">
    <img class="banner-image" src="images/tec_beyond_1.png" alt="The Machine Paradox">
    <h1 class="module-title">The Machine Paradox</h1>
    <h2 class="module-track">Track | <span class="track-category"><i class="fa fa-solid fa-terminal"></i>  Instrumentation</span></h2>
</div>
